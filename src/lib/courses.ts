...
const courses: Course[] = [
...

  {
    ...
    category: "Office & Basics",
    icon: "document",
    tagline: "Word, Excel, PowerPoint and Outlook taught on the documents offices actually use.",
    summary: [
      "The complete Microsoft Office course for office work: professional documents in Word, working spreadsheets in Excel, presentations in PowerPoint and mail handling in Outlook.",
      "Instead of exercises invented for a textbook, you build the real things — a salary slip, a stock register, a quotation, a company presentation — so the work goes straight into your CV portfolio.",
    ],
    seo: {
    ...
    highlights: [
      { icon: "document", title: "Real office documents", text: "Salary slips, stock registers, quotations and reports — not textbook exercises." },
      { icon: "chart", title: "Excel taken seriously", text: "A full month on Excel, including lookups, pivot tables and printing correctly." },
      { icon: "briefcase", title: "Portfolio folder", text: "You leave with a folder of finished documents to show at an interview." },
      { icon: "certificate", title: "Certificate in 3 months", text: "Completion certificate after a practical test on all four applications." },
    ],
    outcomes: [
      "Produce formatted, print-ready business documents with styles, tables and mail merge in Word.",
      "Build working spreadsheets with formulas, lookups, conditional formatting and pivot tables.",
      "Design clear presentations with consistent slide masters, charts and transitions.",
      "Manage mail, calendar and contacts professionally in Outlook.",
      "Move data cleanly between Word, Excel and PowerPoint.",
      "Print any of the above correctly the first time — margins, page breaks and headers included.",
    ],
    audience: [
      "Students and graduates preparing for office roles",
      "Working staff who use Office daily but were never trained on it",
      "Shop and business owners managing their own records",
      "Anyone who has finished the Basic Computer course",
    ],
    eligibility: ["Basic computer familiarity (or our Basic Computer course)", "10th pass or above", "Able to type at a basic level"],
    curriculum: [
      {
        title: "MS Word",
        hours: "22 hours",
        topics: ["Formatting, styles and templates", "Tables, images and page layout", "Headers, footers and page numbering", "Mail merge for letters and labels", "Track changes, review and printing"],
      },
      {
        title: "MS Excel — core",
        hours: "24 hours",
        topics: ["Workbooks, sheets and cell formatting", "Formulas, absolute and relative references", "SUM, IF, COUNTIF, date and text functions", "Sorting, filtering and freezing panes", "Charts and print setup"],
      },
      {
        title: "MS Excel — applied",
        hours: "16 hours",
        topics: ["VLOOKUP and XLOOKUP", "Pivot tables and pivot charts", "Conditional formatting and data validation", "Protecting sheets and workbooks", "Building a stock and attendance register"],
      },
      {
        title: "MS PowerPoint",
        hours: "14 hours",
        topics: ["Slide masters and consistent design", "Text, image and chart slides", "Transitions and animation used sparingly", "Speaker notes and handouts", "Presenting and exporting to PDF"],
      },
      {
        title: "MS Outlook and integration",
        hours: "14 hours",
        topics: ["Account setup, folders and rules", "Professional email writing", "Calendar, meetings and reminders", "Linking Excel data into Word and PowerPoint", "Final practical assessment"],
      },
    ],
    tools: [
      { group: "Documents", items: ["MS Word", "PDF export", "Mail merge"] },
      { group: "Spreadsheets", items: ["MS Excel", "Pivot tables", "Charts"] },
      { group: "Presentation & mail", items: ["MS PowerPoint", "MS Outlook", "Google Docs", "Google Sheets"] },
    ],
    projects: [
      { title: "Company letterhead pack", text: "Build a reusable letterhead, quotation template and offer letter with mail merge.", tags: ["Word", "Mail merge"] },
      { title: "Stock and attendance register", text: "A working Excel register with lookups, validation and a monthly summary pivot.", tags: ["Excel", "Pivot"] },
      { title: "Business review deck", text: "A ten-slide review presentation built on a slide master, with charts linked from Excel.", tags: ["PowerPoint", "Charts"] },
    ],
    careers: [
      { role: "Office Executive", salary: "₹1.8 – 3.0 LPA", demand: "Very high" },
      { role: "Back Office Assistant", salary: "₹1.6 – 2.8 LPA", demand: "High" },
      { role: "Documentation Assistant", salary: "₹1.8 – 3.2 LPA", demand: "Moderate" },
      { role: "Receptionist / Front Desk", salary: "₹1.4 – 2.6 LPA", demand: "High" },
    ],
    batches: [
    ...
    faqs: [
      ["Which version of Office do you teach?", "Microsoft 365 / Office 2021 in the lab. The menus are explained so that you can also work on older 2016 and 2019 installations at your workplace."],
      ["Is Excel covered properly, or only the basics?", "Forty hours of the course are Excel, including lookups, pivot tables, validation and printing. If you need macros, Power Query and dashboards, continue with the Advance Excel course."],
      ["Can I join only the Excel part?", "Yes. Modules can be taken separately at a reduced fee, though most students find the full course better value."],
    ],
    reviews: [
      { initials: "MK", name: "Manpreet K.", role: "Office Executive, Jalandhar", text: "Mail merge alone saved me hours in my first week at work. My manager asked who trained me." },
      { initials: "AS", name: "Amit S.", role: "Back office, Phagwara", text: "The stock register we built in class is the exact file I now use at my job, with a few changes." },
    ],
